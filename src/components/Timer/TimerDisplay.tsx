                    ...
                    {timerStatus === 'task' ? (
                        <>
                            <svg
                                ...
                                className="h-9 w-9 animate-spin fill-orange-400"
                                viewBox="0 0 24 24"
                            >
                            ...
                            <span className="dark:text-slate-500 text-slate-400 font-semibold text-sm">
                                Timer is Active
                            </span>
                        </>
                    ) : (
                        <>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                className="h-9 w-9 animate-pulse fill-purple-400"
                                viewBox="0 0 24 24"
                            >
                            ...
                            <span className="dark:text-slate-500 font-semibold text-slate-400 text-sm">
                                Break is Active
                            </span>
                        </>
                    )}
